...
const caseStudies: CaseStudy[] = [
  {
    ...
    hero: "hospital",
    summary: "Comprehensive digital transformation for a leading multi-speciality hospital, managing all creative assets, social media presence, and performance marketing campaigns.",
    challenge: "Altius Hospital faced challenges in digital visibility and patient engagement. Their social media presence was inconsistent, with low engagement rates and limited reach. The hospital needed a unified digital strategy that could communicate their quality healthcare services effectively while competing with larger healthcare chains in the region.",
    solution: "I implemented a comprehensive digital marketing strategy including: (1) Complete brand identity refresh with consistent visual elements, (2) Weekly video content production including doctor interviews, patient testimonials, and health awareness reels, (3) Meta and Google Ads campaigns targeting specific demographics, (4) WhatsApp marketing for appointment reminders and health tips, (5) SEO optimization for the hospital website, and (6) Regular community engagement through health awareness posts.",
    results: [
      { value: "23%", label: "Increase in Patient Inflow", icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" },
      { value: "25%", label: "Boost in Digital Engagement", icon: "M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" },
      { value: "24hr", label: "Content Turnaround", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
      { value: "15K+", label: "Social Media Followers", icon: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" }
    ],
    services: ["Social Media Management", "Video Production", "Meta Ads", "Google Ads", "Brand Identity", "Content Strategy", "WhatsApp Marketing", "SEO"],
    deliverables: ["200+ Social Media Posts", "50+ Video Contents", "12 Ad Campaigns", "Monthly Analytics Reports", "Brand Guidelines", "Website Updates"],
    testimonials: {
      quote: "Geetha's work transformed our digital presence. The increase in patient inquiries has been remarkable.",
      name: "Dr. Darshana Reddy",
      role: "Managing Director, Altius Hospital"
    }
  },
  {
    ...
    results: [
      ...
      { value: "40%", label: "Unique Reach Growth", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
      { value: "4K+", label: "Avg Views Per Video", icon: "M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" }
    ],
    services: ["Social Media Management", "Content Creation", "Video Production", "Brand Strategy", "SEO/AEO/GEO", "Graphics Design", "Reels Creation", "Google My Business"],
    deliverables: ["Custom Content Strategies", "Weekly Content Calendars", "Video & Reels", "Graphic Designs", "Monthly Reports", "Audience Growth Plans"],
    testimonials: {
      quote: "Our online presence has grown tremendously. The content quality and engagement are outstanding.",
  ...
  },
  {
    ...
    subtitle: "Educational Institution Marketing",
    category: "Social Media & Digital Marketing",
    client: "Koshys Group of Institution",
    role: "Social Media Manager",
    period: "Jan 2026 - Present",
    hero: "education",
    summary: "Managing complete digital presence for an educational institution including content strategy, SEO optimization, web design, and creative content creation.",
    challenge: "Koshys Group needed to establish a strong digital presence in the competitive education sector. The institution required a comprehensive approach covering social media, website optimization, and creative content that could attract prospective students and build brand authority.",
    solution: "Currently implementing: (1) Complete social media strategy for multiple programs, (2) SEO/AEO/GEO optimization for better search visibility, (3) Creative video content for campus tours and student testimonials, (4) Web design and optimization improvements, (5) Content marketing for thought leadership, (6) Lead generation campaigns.",
    results: [
      { value: "Ongoing", label: "SEO Optimization", icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" },
      { value: "In Progress", label: "Content Strategy", icon: "M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" },
      { value: "Developing", label: "Video Content", icon: "M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" },
      { value: "Active", label: "Web Optimization", icon: "M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" }
    ],
    services: ["Social Media Management", "SEO/AEO/GEO", "Video Production", "Web Design", "Content Strategy", "Lead Generation"],
    deliverables: ["Monthly Content Calendar", "Video Content", "SEO Reports", "Website Updates", "Admission Campaigns"]
  }
]
