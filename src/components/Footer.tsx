    ...
    <footer className="py-16 px-6 border-t border-white/10">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/60">
              ...
              <li><Link to="/about" className="hover:text-[#00F5D4] transition-colors">About</Link></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-white/40 text-sm">
          <p>© {new Date().getFullYear()} Geetha Gokula P. All rights reserved.</p>
          <p>YUVA Summit India Winner | Best Core Organizing Team RANVITA 2024</p>
        </div>
      </div>
    </footer>
  )
