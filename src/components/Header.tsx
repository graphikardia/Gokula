...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed top-0 w-full z-40 py-4 px-6 backdrop-blur bg-white/5 dark:bg-black/30">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <Link to="/" className="font-bold text-lg tracking-wider z-50">
          ...
          >
            <div className="w-6 h-5 flex flex-col justify-between">
              <motion.span
                ...
                className="w-full h-0.5 bg-white dark:bg-black block"
              />
              <motion.span
      ...
      <motion.div
        ...
        className="fixed inset-0 z-40 bg-white dark:bg-black/95 backdrop-blur md:hidden"
      >
        <div className="flex flex-col items-center justify-center h-full gap-8">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="p-3 rounded-full bg-white/10 border border-white/20 dark:bg-white/10 dark:border-white/20"
